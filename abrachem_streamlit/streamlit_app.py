...
with st.sidebar:
    ...
    if store.backend_activo() == "postgres":
        st.success("Base de datos: Postgres (persistencia permanente) ✓", icon="🗄️")
    else:
        st.warning("Base de datos: SQLite local. En Streamlit Cloud esto se "
                   "borra al redeployar — configurá Postgres para guardar "
                   "todo de forma permanente (ver README).", icon="🗄️")
